...
set -g status-left ""
set -g status-right "#[fg=colour7,bg=colour8]#[fg=colour15,bg=colour7] #h "

setw -g window-status-format "#[fg=colour8,bg=colour23]#[fg=colour15,bg=colour23] #I:#W #[fg=colour23,bg=colour8]"
setw -g window-status-current-format "#[fg=colour8,bg=colour7]#[fg=colour15,bg=colour7] #I:#W #[fg=colour7,bg=colour8]"
